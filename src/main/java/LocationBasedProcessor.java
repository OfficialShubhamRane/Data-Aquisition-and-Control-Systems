public class LocationBasedProcessor {
    ...
    /** Get Latitude and Longitude of  machine (laptop) */

    /** Get City name and city weather from latitude and longitude */

    /** Combine System.time with weather of location for machine (city) */

    /** Use weather report to suggest different operations to operator eg.
    ...
    /** Get map/topology map around machine in image format, based on latitude and longitude
